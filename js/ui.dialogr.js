 ...
 * Maintained and improved by Francisco J. Cruz Romanos (grisendo@gmail.com)
 *
  ...
  $.widget(
    "ui.dialogr",
    {
      ...
      _create: function() {
        ...
        var titleId = $.ui.dialogr.getTitleId(this.element);
        var uiDialog = (this.uiDialog = $('<div/>')).appendTo(this.options.parent).hide().addClass(uiDialogClasses + options.dialogClass).css( {
          position : 'absolute',
          overflow : 'hidden',
        ...
        var uiDialogContent = this.element.show().removeAttr('title').addClass('ui-dialog-content ' + 'ui-widget-content').appendTo(uiDialog);
        var uiDialogTitlebar = (this.uiDialogTitlebar = $('<div></div>')).addClass('ui-dialog-titlebar ' + 'ui-widget-header ' + 'ui-corner-all ' + 'ui-helper-clearfix').prependTo(uiDialog);
        var uiDialogTitlebarClose = $('<a href="#"/>').addClass('ui-dialog-titlebar-close ' + 'ui-corner-all').attr('role', 'button').hover(
          function() {
        ...
        var uiDialogTitlebarCloseText = (this.uiDialogTitlebarCloseText = $('<span/>')).addClass('ui-icon ' + 'ui-icon-closethick').text(options.closeText).appendTo(uiDialogTitlebarClose);
        var uiDialogTitle = $('<span/>').addClass('ui-dialog-title').attr('id', titleId).html(title).prependTo(uiDialogTitlebar);
        ...
        if (self.options.maximized) {
          uiDialogTitlebar.append('<a href="#" id="dialog-maximize" class="ui-dialog-titlebar-max"><span>' + self.options.maximizeText + '</span></a>');
          this.uiDialogTitlebarMax = $('#dialog-maximize', uiDialogTitlebar).hover(
            function() {
        ...
        if (self.options.minimized) {
          uiDialogTitlebar.append('<a href="#" id="dialog-minimize" class="ui-dialog-titlebar-min"><span>' + self.options.minimizeText + '</span></a>');
          this.uiDialogTitlebarMax = $('#dialog-minimize', uiDialogTitlebar).hover(
            function() {
        ...
        if (self.options.minimized || self.options.maximized) {
          uiDialogTitlebar.append('<a href="#" id="dialog-restore" class="ui-dialog-titlebar-rest"><span>' + self.options.restoreText + '</span></a>');
          this.uiDialogTitlebarMin = $('#dialog-restore', uiDialogTitlebar).hover(
            function() {
